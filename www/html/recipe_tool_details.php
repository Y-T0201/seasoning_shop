    ...
    if (isset($_POST['update_post']) === true) {
        ...
        if (count($err_msg) === 0) {
            ...
            $sql = 'UPDATE ec_recipe_master
                    ...
                    SET recipe_name = ?, item_id = ?, recipe_comment = ?, recipe_status = ?,
            ...
            $stmt->bindvalue(3, $update_recipe_comment, PDO::PARAM_STR);
            $stmt->bindvalue(4, $change_recipe_status, PDO::PARAM_INT);
            $stmt->bindvalue(5, $update_person, PDO::PARAM_INT);
            $stmt->bindvalue(6, $update_recipe_material, PDO::PARAM_STR);
            $stmt->bindvalue(7, $update_recipe, PDO::PARAM_STR);
            $stmt->bindvalue(8, $update_point, PDO::PARAM_STR);
            $stmt->bindvalue(9, $recipe_id, PDO::PARAM_INT);
            // SQLを実行
            $stmt->execute();
...
<form class = "recipe_change" method = "post" enctype = "multipart/form-data">
    <p>料理名(29文字以内):<input type = "text" name = "update_recipe_name" value = "<?php print htmlspecialchars($recipe_details['recipe_name'], ENT_QUOTES, 'utf-8'); ?>"></p>
    <p>料理画像:</p>
    ...
    <p>人数(人分):<input type = "text" name = "update_person" value = "<?php print htmlspecialchars($recipe_details['person'], ENT_QUOTES, 'utf-8'); ?>"></p>
    <p>材料:</p>
